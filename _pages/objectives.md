...
- **RG1 → RO1**: To develop a high-fidelity numerical model of a prestressed concrete girder based on experimental girder.
...
- **RG3 → RO3**: To verify and adjust the advanced SHM methodology on a case study.

 <img src="/images/evpres.png"/>